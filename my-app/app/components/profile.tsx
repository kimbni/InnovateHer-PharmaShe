        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. 165"
              className="w-full px-4 py-2 border border-[rgb(205,160,177)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(163,75,103)]"
            />
          </div>
          <div>
        ...
        {bmi !== null && (
          <div className="p-4 rounded-lg bg-[rgb(255,250,252)] border border-[rgb(205,160,177)]">
            ...
            <p className="text-2xl font-bold text-gray-800">
              {bmi} <span className="text-base font-normal text-gray-600">kg/m²</span>
            </p>
            {bmiCategory && (
              <p className="text-sm text-gray-600 mt-1">Category: {bmiCategory}</p>
            )}
