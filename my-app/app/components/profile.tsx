       ...
       <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
         ...
         {bmi !== null && (
           <div className="p-4 rounded-lg bg-[rgb(255,250,252)] border border-[rgb(205,160,177)]">
             ...
             {bmiCategory && (
               <p className="text-sm text-black mt-1">Category: {bmiCategory}</p>
             )}
         ...
         <div>
           <label htmlFor="conditions" className="block text-sm font-medium text-black mb-1">
         ...
         <div>
           <label htmlFor="concerns" className="block text-sm font-medium text-black mb-1">
