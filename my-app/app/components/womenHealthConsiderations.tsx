    ...
    <div className="card">
      ...
      <div className="space-y-4">
        <div className="border-l-4 border-[rgb(163,75,103)] pl-4">
          <h4 className="font-semibold text-black mb-2">Hormonal Interactions</h4>
        ...
        <div className="border-l-4 border-[rgb(205,160,177)] pl-4">
          <h4 className="font-semibold text-black mb-2">Pregnancy & Breastfeeding</h4>
          <p className="text-sm text-gray-700">
        ...
        <div className="border-l-4 border-[rgb(86,109,150)] pl-4">
          <h4 className="font-semibold text-black mb-2">Sex-Based Differences</h4>
          <p className="text-sm text-gray-700">
        ...
        <div className="border-l-4 border-[rgb(163,75,103)] pl-4">
          <h4 className="font-semibold text-black mb-2">Side Effect Profiles</h4>
          <p className="text-sm text-gray-700">
